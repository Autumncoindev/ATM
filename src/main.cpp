...
const string strMessageMagic = "autumncoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 96)
    {
        nSubsidy = 3 * COIN;
    }
    else if(pindexBest->nHeight < 3690)
    {
        nSubsidy = 936 * COIN;
    }
    else if(pindexBest->nHeight < 6390)
    {
        nSubsidy = 639 * COIN;
    }
    else if(pindexBest->nHeight < 30096)
    {
        nSubsidy = 369 * COIN;
    }
    else if(pindexBest->nHeight < 36900)
    {
        nSubsidy = 96 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "autumncoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The leaves are on the ground winters coming again.";
        CTransaction txNew;
        txNew.nTime = 1443192587;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb7210883321d0b44c204fe7f92cf4e11d7f3c3b2882de263185af0478d8b5ad3"));
...
unsigned char pchMessageStart[4] = { 0x55, 0x52, 0x12, 0x0d };
